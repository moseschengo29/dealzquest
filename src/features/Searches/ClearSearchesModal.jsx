...
import { useClearSearches } from "./useClearSearches";

function ClearSearchesModal({ close }) {
    const {clearSearchHistory, isDeleting} = useClearSearches(close)
  const handleClear = (e) => {
    console.log('clicked')
    clearSearchHistory()
  }
  ...
  return (
    <Modal close={close}>
            <div className="py-6 px-4 text-center bg-gray-800 dark:bg-boxdark">
                    ...
                    <h3 className="text-xl font-normal text-gray-300 mt-5 mb-6">Are you sure you want to clear all your searches?</h3>
                    <div
                        onClick={handleClear}
